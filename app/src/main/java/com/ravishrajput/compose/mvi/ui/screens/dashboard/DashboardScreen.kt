...
import com.ravishrajput.compose.mvi.R
import com.ravishrajput.compose.mvi.ui.theme.JetpackcomposemviexampleTheme

@Composable
fun ShowDashboardScreen(navController: NavController, viewModel: DashboardViewModel) {

  val state = viewModel.viewState.collectAsState(initial = DashboardViewState.Default).value
  viewModel.applyAction(DashboardViewAction.Launch)
